...
namespace NetPinProc.Domain
{
	...
	public class I2cServo
	{
        ...
        /// <summary>
		/// servo number must be between 0 and 15
		/// </summary>
        ...
        /// <summary>
        /// Stop. Write our servo value via i2c
        /// </summary>
        public void Stop()
		{
			this.platform.i2c_write8(this.config.address, 0x06 + this.number * 4, 0);
        ...
        /// <summary>
        /// The LED control registers on the PCA9685 start at 0x06.There are a total of 4 1-byte control registers per LED. <para/>
