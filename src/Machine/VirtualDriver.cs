...
namespace NetPinProc.Domain
{
    ...
    public class VirtualDriver : Driver, IVirtualDriver
    {
        ...
        /// <summary>
        /// Changes the state and invokes the method set on the <see cref="_stateChangeHandler"/>
        /// </summary>
        ...
        public void ChangeState(bool newState)
        {
            ...
            _stateChangeHandler?.DynamicInvoke();
        }
        ...
        public override void Pulse(int milliseconds = -1)
        {
        ...
        /// <summary>
        /// Checks if time expired and disables or increments the schedule
        /// </summary>
